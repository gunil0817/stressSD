...
dirDM = '\GLM001_R4_M16_singResp_ChosenVal_n41_0328'; % directory for 1st lvl glm
...
contrastName = {'chosenVal', 'SI_onset'};
contrastVector{1} = [0 0  0 1];
contrastVector{2} = [0 0  1 0];
...
for numSubj = 1:length(onsetList)
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).pmod(1) = struct('name', 'chosen', 'param', onsetTime{37}, 'poly', 1);
