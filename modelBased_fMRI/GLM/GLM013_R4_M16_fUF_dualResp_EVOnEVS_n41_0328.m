...
dirDM = '\GLM013_R4_M16_fuf_dualResp_EVOnEVS_n41_0328'; % directory for 1st lvl glm
...
for numSubj = 1:length(onsetList)
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).name = 'equal'; %target + incentive
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).pmod(2) = struct('name', 'EVS', 'param', onsetTime{26}, 'poly', 1);
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).orth = 0;


    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(3).name = 'targetMore'; %target + incentive
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(3).pmod(2) = struct('name', 'EVS', 'param', onsetTime{28}, 'poly', 1);
