...
for subjs = 1:length(list_trt)
    ...
    ev_self = SV(:,1) - mean(SV(:,1));
    ev_other = SV(:,2) - mean(SV(:,2));
    ...
    valDiffTwo = amount_other*1./social_distance + amount_default - amount_self;
    valDiffTwo = valDiffTwo - mean(valDiffTwo);
